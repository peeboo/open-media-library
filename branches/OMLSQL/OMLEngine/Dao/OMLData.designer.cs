...
namespace OMLEngine.Dao
{
    ...
    partial void OnIdChanged();
		...
		[Association(Name="GenreMetaData_Genre", Storage="_GenreMetaData", ThisKey="GenreMetaDataId", IsForeignKey=true)]
		...
		[Association(Name="Title_Genre", Storage="_Title", ThisKey="TitleId", IsForeignKey=true)]
		public Title Title
		{
			get
			{
    ...
    partial void OnGroupIdChanged();
		...
		[Association(Name="Title_Genre", Storage="_Genres", OtherKey="TitleId")]
		...
		[Association(Name="Title_Person", Storage="_Peoples", OtherKey="TitleId")]
		...
		[Association(Name="Title_Tag", Storage="_Tags", OtherKey="TitleId")]
		...
		[Association(Name="Title_Disk", Storage="_Disks", OtherKey="TitleId")]
    ...
    partial void OnIdChanged();
		...
		[Association(Name="BioData_Person", Storage="_BioData", ThisKey="BioId", IsForeignKey=true)]
		...
		[Association(Name="Title_Person", Storage="_Title", ThisKey="TitleId", IsForeignKey=true)]
		public Title Title
		{
			get
			{
    ...
    partial void OnIdChanged();
		...
		[Association(Name="Title_Tag", Storage="_Title", ThisKey="TitleId", IsForeignKey=true)]
		public Title Title
		{
			get
			{
    ...
    partial void OnExtraOptionsChanged();
		...
		[Association(Name="Title_Disk", Storage="_Title", ThisKey="TitleId", IsForeignKey=true)]
		public Title Title
		{
			get
			{
