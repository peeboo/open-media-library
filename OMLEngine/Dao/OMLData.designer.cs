...
namespace OMLEngine.Dao
{
    ...
    partial void OnItemGUIDChanged();
		...
		[Column(Name="ItemImage", Storage="_Image", DbType="Image NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		...
		[Column(Storage="_ItemGUID", DbType="uniqueidentifier", IsDbGenerated=true)]
