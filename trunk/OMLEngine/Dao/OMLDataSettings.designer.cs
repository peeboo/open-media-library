...
namespace OMLEngine.Dao
{
    ...
    partial void DeleteWatchedFolder(WatchedFolder instance);
		...
		public System.Data.Linq.Table<WatchedFolder> WatchedFolders
		{
			get
			{
	...
	public partial class WatchedFolder : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnParentTitleChanged();
		...
		[Column(Storage="_InstanceName", DbType="NVarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string InstanceName
		{
			get
			{
		...
		[Column(Storage="_Folder", DbType="NChar(255) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Storage="_ParentTitle", DbType="Int")]
		public System.Nullable<int> ParentTitle
		{
			get
			{
			...
			set
			{
				...
				{
					this.OnParentTitleChanging(value);
					this.SendPropertyChanging();
