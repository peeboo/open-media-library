...
// mencoder <filename.m2ts> -o <output filename> -oac copy -ovc lavc -lavcopts codec=???:vbitrate=???? -fps <30|60> -vf -scale=1280:720 (note: -scale=1920:1080 is not a good idea, encoding would really suck)
