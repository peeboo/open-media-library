...
{
    public class EpisodeItem : GalleryItem
    {
        ...
        {            
            ...
            {
                string imgPath = this._titleObj.ThumbnailMenuPath;
                ...
                {
                    this._titleObj.BeginGetThumbnailMenuPath(delegate
                    {
                        string path = _titleObj.ThumbnailMenuPath;
