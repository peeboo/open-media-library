...
{
    public class AlphaPivot : BrowsePivot
    {
        ...
        public AlphaPivot(IModelItemOwner owner, string stDescription, string stNoContentText, List<OMLEngine.TitleFilter> filters)
        ...
        public AlphaPivot(IModelItemOwner owner, string stDescription, string stNoContentText, IList listContent)
