...
{
    public class TrailerPivot : BrowsePivot
    {
        public TrailerPivot(IModelItemOwner owner, string stDescription, string stNoContentText)
        ...
        public TrailerPivot(IModelItemOwner owner, string stDescription, string stNoContentText, List<OMLEngine.TitleFilter> filters, OMLEngine.TitleFilterType filterType)
            : base(owner, stDescription, stNoContentText, null)
        {
